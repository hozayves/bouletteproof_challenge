    ...
    return (
        <div className="w-full">
            <div className="border w-full min-w-full flex flex-col p-3 rounded-lg bg-white">
                ...
                <div className="flex align-center gap-14 mt-4">
                    <p className="font-medium text-3xl">632</p>
                    <div className="flex justify-center items-center bg-pink-100 rounded-full px-3 h-[28px] self-center gap-1">
                        ...
                        <p className="text-sm leading-none text-pink-700">15%</p>
                    </div>
                </div>
                <p className="mt-1 text-gray-400 text-sm">vs Last Month</p>
            </div>
        </div>
    )
}